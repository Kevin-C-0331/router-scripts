...
# ==================== 分区/overlay/Docker（mt3000.sh核心功能） ================
...
while true; do
	...
	echo
	cyan " 7. 一键更换 overlay 分区到U盘"
	cyan " 8. 安装 Docker (需overlay在U盘)"
	cyan " 9. 自定义设置软件包分区大小 (GB)"
	yellow "10. 重新绑定U盘为overlay分区"
	echo
	echo " Q. 退出本程序"
	echo
